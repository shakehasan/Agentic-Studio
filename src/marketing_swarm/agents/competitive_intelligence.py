...
class CompetitiveIntelligenceAgent(MarketingAgent):
    """Competitive Intelligence Agent: Map alternatives, positioning, differentiation, SWOT, pricing narratives, and comparison frames."""
    ...
    def __init__(self, **kwargs: Any) -> None:
        spec = AgentSpec(
            ...
            allowed_tools=['research_corpus', 'hybrid_search', 'reranker', 'claim_extractor'],
            deliverables=['competitor_map', 'swot', 'differentiation_angles', 'comparison_table'],
            handoff_targets=['content_strategy', 'copywriter'],
