...
class ContentStrategistAgent(MarketingAgent):
    """Content Strategist Agent: Create funnel architecture, content pillars, channel mix, editorial calendar, and messaging hierarchy."""

    def __init__(self, **kwargs: Any) -> None:
        spec = AgentSpec(
            slug="content_strategy",
            display_name="Content Strategist Agent",
            role="Create funnel architecture, content pillars, channel mix, editorial calendar, and messaging hierarchy.",
            allowed_tools=['calendar_builder', 'template_renderer', 'keyword_seo_scorer', 'artifact_validator'],
            deliverables=['content_pillars', 'funnel_map', 'editorial_calendar', 'messaging_hierarchy'],
            handoff_targets=['copywriter', 'seo_geo'],
