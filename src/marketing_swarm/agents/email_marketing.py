...
class EmailMarketingAgent(MarketingAgent):
    """Email Marketing Agent: Build lifecycle sequences, subject-line variants, segmentation logic, and send-cadence plans."""
    ...
    def __init__(self, **kwargs: Any) -> None:
        spec = AgentSpec(
            ...
            allowed_tools=['readability_analyzer', 'tone_sentiment_analyzer', 'template_renderer', 'artifact_validator'],
            deliverables=['welcome_sequence', 'nurture_sequence', 'subject_lines', 'segmentation_logic'],
            handoff_targets=['brand_voice_qa', 'analytics_optimization'],
