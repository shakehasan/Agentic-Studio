...
class MarketResearchAgent(MarketingAgent):
    """Market Research Agent: Build personas, demand signals, market narratives, segmentation, and audience assumptions."""
    ...
    def __init__(self, **kwargs: Any) -> None:
        spec = AgentSpec(
            ...
            allowed_tools=['research_corpus', 'hybrid_search', 'persona_synthesizer', 'claim_extractor'],
            deliverables=['audience_segments', 'personas', 'market_narrative', 'demand_signals'],
            handoff_targets=['content_strategy', 'competitive_intelligence'],
