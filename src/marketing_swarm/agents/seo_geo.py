...
class SeoGeoAgent(MarketingAgent):
    """SEO / GEO Agent: Cluster keywords, map search intent, design on-page recommendations, internal links, and answer-engine citation plans."""

    def __init__(self, **kwargs: Any) -> None:
        spec = AgentSpec(
            slug="seo_geo",
            display_name="SEO / GEO Agent",
            role="Cluster keywords, map search intent, design on-page recommendations, internal links, and answer-engine citation plans.",
            allowed_tools=['keyword_seo_scorer', 'hybrid_search', 'reranker', 'claim_extractor'],
            deliverables=['keyword_clusters', 'intent_map', 'on_page_plan', 'answer_engine_plan'],
            handoff_targets=['brand_voice_qa', 'content_strategy'],
