...
class SocialMediaAgent(MarketingAgent):
    """Social Media Agent: Create channel-specific posts, thread structures, publishing cadence, hooks, and ready-to-publish specs."""
    ...
    def __init__(self, **kwargs: Any) -> None:
        spec = AgentSpec(
            ...
            allowed_tools=['calendar_builder', 'tone_sentiment_analyzer', 'readability_analyzer', 'template_renderer'],
