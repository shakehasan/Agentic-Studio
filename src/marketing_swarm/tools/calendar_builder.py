...
class CalendarBuilderTool(BaseTool):
    """Builds channel-aware campaign calendars and cadence plans."""

    name = "calendar_builder"
    description = "Builds channel-aware campaign calendars and cadence plans."
    ...
    def _run(self, payload: Mapping[str, Any], context: ToolContext) -> dict[str, Any]:
        """Execute Calendar Builder with deterministic, typed behavior."""
    ...
    def _specialized_result(
        ...
        return {
            "summary": "Calendar Builder processed the request with local heuristics.",
