...
class ClaimExtractorTool(BaseTool):
    """Extracts factual claims and creates verification tasks with citations."""

    name = "claim_extractor"
    description = "Extracts factual claims and creates verification tasks with citations."
    ...
    def _run(self, payload: Mapping[str, Any], context: ToolContext) -> dict[str, Any]:
        """Execute Claim Extractor with deterministic, typed behavior."""
    ...
    def _specialized_result(
        ...
        return {
            "summary": "Claim Extractor processed the request with local heuristics.",
