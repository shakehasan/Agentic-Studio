...
class ExperimentDesignerTool(BaseTool):
    """Generates statistically literate A/B experiment plans and readout criteria."""

    name = "experiment_designer"
    description = "Generates statistically literate A/B experiment plans and readout criteria."
    ...
    def _run(self, payload: Mapping[str, Any], context: ToolContext) -> dict[str, Any]:
        """Execute Experiment Designer with deterministic, typed behavior."""
    ...
    def _specialized_result(
        ...
        return {
            "summary": "Experiment Designer processed the request with local heuristics.",
