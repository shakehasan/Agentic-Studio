...
class HybridSearchTool(BaseTool):
    """Combines local vector search and lexical search with reciprocal rank fusion."""

    name = "hybrid_search"
    description = "Combines local vector search and lexical search with reciprocal rank fusion."
    ...
    def _run(self, payload: Mapping[str, Any], context: ToolContext) -> dict[str, Any]:
        """Execute Hybrid Search with deterministic, typed behavior."""
    ...
    def _specialized_result(
        ...
        return {
            "summary": "Hybrid Search processed the request with local heuristics.",
