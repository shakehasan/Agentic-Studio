...
class MarkdownAssetWriterTool(BaseTool):
    """Writes safe markdown artifacts to the configured output directory."""

    name = "markdown_asset_writer"
    description = "Writes safe markdown artifacts to the configured output directory."
    ...
    def _run(self, payload: Mapping[str, Any], context: ToolContext) -> dict[str, Any]:
        """Execute Markdown Asset Writer with deterministic, typed behavior."""
    ...
    def _specialized_result(
        ...
        return {
            "summary": "Markdown Asset Writer processed the request with local heuristics.",
