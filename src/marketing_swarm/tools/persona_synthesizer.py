...
class PersonaSynthesizerTool(BaseTool):
    """Synthesizes audience personas from brief and evidence snippets."""

    name = "persona_synthesizer"
    description = "Synthesizes audience personas from brief and evidence snippets."
    ...
    def _run(self, payload: Mapping[str, Any], context: ToolContext) -> dict[str, Any]:
        """Execute Persona Synthesizer with deterministic, typed behavior."""
    ...
    def _specialized_result(
        ...
        return {
            "summary": "Persona Synthesizer processed the request with local heuristics.",
