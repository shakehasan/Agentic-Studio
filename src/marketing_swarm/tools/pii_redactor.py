...
class PiiRedactorTool(BaseTool):
    """Redacts email, phone, address-like, and account-like sensitive strings."""

    name = "pii_redactor"
    description = "Redacts email, phone, address-like, and account-like sensitive strings."
    ...
    def _run(self, payload: Mapping[str, Any], context: ToolContext) -> dict[str, Any]:
        """Execute Pii Redactor with deterministic, typed behavior."""
    ...
    def _specialized_result(
        ...
        return {
            "summary": "Pii Redactor processed the request with local heuristics.",
