...
class ReadabilityAnalyzerTool(BaseTool):
    """Computes readability, sentence length, and clarity improvement hints."""

    name = "readability_analyzer"
    description = "Computes readability, sentence length, and clarity improvement hints."
    ...
    def _run(self, payload: Mapping[str, Any], context: ToolContext) -> dict[str, Any]:
        """Execute Readability Analyzer with deterministic, typed behavior."""
    ...
    def _specialized_result(
        ...
        return {
            "summary": "Readability Analyzer processed the request with local heuristics.",
