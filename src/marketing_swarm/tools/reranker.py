...
class RerankerTool(BaseTool):
    """Reranks candidate passages with a deterministic cross-feature scorer."""

    name = "reranker"
    description = "Reranks candidate passages with a deterministic cross-feature scorer."
    ...
    def _run(self, payload: Mapping[str, Any], context: ToolContext) -> dict[str, Any]:
        """Execute Reranker with deterministic, typed behavior."""
    ...
    def _specialized_result(
        ...
        return {
            "summary": "Reranker processed the request with local heuristics.",
