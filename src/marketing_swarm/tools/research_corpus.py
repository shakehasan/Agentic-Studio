...
class ResearchCorpusTool(BaseTool):
    """Searches the seeded offline research corpus and returns cited passages."""

    name = "research_corpus"
    description = "Searches the seeded offline research corpus and returns cited passages."
    ...
    def _run(self, payload: Mapping[str, Any], context: ToolContext) -> dict[str, Any]:
        """Execute Research Corpus with deterministic, typed behavior."""
    ...
    def _specialized_result(
        ...
        return {
            "summary": "Research Corpus processed the request with local heuristics.",
