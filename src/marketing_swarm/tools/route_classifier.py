...
class RouteClassifierTool(BaseTool):
    """Classifies routing mode, route confidence, and recommended specialist order."""

    name = "route_classifier"
    description = "Classifies routing mode, route confidence, and recommended specialist order."
    ...
    def _run(self, payload: Mapping[str, Any], context: ToolContext) -> dict[str, Any]:
        """Execute Route Classifier with deterministic, typed behavior."""
    ...
    def _specialized_result(
        ...
        return {
            "summary": "Route Classifier processed the request with local heuristics.",
