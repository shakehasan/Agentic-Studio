...
class TemplateRendererTool(BaseTool):
    """Renders structured markdown artifacts from typed sections."""

    name = "template_renderer"
    description = "Renders structured markdown artifacts from typed sections."
    ...
    def _run(self, payload: Mapping[str, Any], context: ToolContext) -> dict[str, Any]:
        """Execute Template Renderer with deterministic, typed behavior."""
    ...
    def _specialized_result(
        ...
        return {
            "summary": "Template Renderer processed the request with local heuristics.",
