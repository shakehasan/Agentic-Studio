...
class VectorSearchTool(BaseTool):
    """Runs local vector similarity search over the embedded knowledge base."""

    name = "vector_search"
    description = "Runs local vector similarity search over the embedded knowledge base."
    ...
    def _run(self, payload: Mapping[str, Any], context: ToolContext) -> dict[str, Any]:
        """Execute Vector Search with deterministic, typed behavior."""
    ...
    def _specialized_result(
        ...
        return {
            "summary": "Vector Search processed the request with local heuristics.",
